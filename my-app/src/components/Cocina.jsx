        ...
        {orders.map(order => (
          <article key={order.id}>
            ...
            <header>
              ...
              <p>Numero de mesa: {order.nroMesa}</p>
            </header>
            ...
            {order.status === 'placed'
              ? <button onClick={() => updateOrder(order.id, 'prepared')}>Cambiar a parepada</button>
              : order.status === 'prepared'
                ? <button onClick={() => updateOrder(order.id, 'delivered')}>Cambiar a entregada</button>
                : <span>Entregada</span>
            }
          </article>
        ))}
